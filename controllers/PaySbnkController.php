...
/**
 * PaySbnkController implements the CRUD actions for PaySbnk model.
 */
class PaySbnkController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Displays a single PaySbnk model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Updates an existing PaySbnk model.
    ...
    /**
     * Deletes an existing PaySbnk model.
    ...
    /**
     * Finds the PaySbnk model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return PaySbnk the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = PaySbnk::findOne(['id' => $id])) !== null) {
            return $model;
        }
