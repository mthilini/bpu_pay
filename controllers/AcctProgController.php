...
/**
 * AcctProgController implements the CRUD actions for AcctProg model.
 */
class AcctProgController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all AcctProg models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new AcctProgSearch();
    ...
    /**
     * Displays a single AcctProg model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Updates an existing AcctProg model.
    ...
    /**
     * Deletes an existing AcctProg model.
    ...
    /**
     * Finds the AcctProg model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return AcctProg the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AcctProg::findOne(['id' => $id])) !== null) {
            return $model;
        }
