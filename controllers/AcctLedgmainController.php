...
/**
 * AcctLedgmainController implements the CRUD actions for AcctLedgmain model.
 */
class AcctLedgmainController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Displays a single AcctLedgmain model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new AcctLedgmain model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new AcctLedgmain();
    ...
    /**
     * Updates an existing AcctLedgmain model.
    ...
    /**
     * Deletes an existing AcctLedgmain model.
    ...
    /**
     * Finds the AcctLedgmain model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return AcctLedgmain the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AcctLedgmain::findOne(['id' => $id])) !== null) {
            return $model;
        }
