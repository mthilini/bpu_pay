            ...
            <?php foreach ($modelsCash as $index => $modelCash): ?>
                <div class="item panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <?= $form->field($modelCash, "[{$index}]payVch")->textInput(['maxlength' => true]) ?>
                            </div>
                            <div class="col-sm-4">
                                <?= $form->field($modelCash, "[{$index}]payType")->textInput(['maxlength' => true]) ?>
                            </div>
                            <div class="col-sm-4">
...
<div class="row">
        <div class="col-sm-6">
            <?= $form->field($model, 'payPrepared')->textInput(['maxlength' => true]) ?>
        </div>
        <div class="col-sm-6">
            <?= $form->field($model, 'payDatePrepare')->textInput() ?>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($model, 'payCertify')->textInput(['maxlength' => true]) ?>
        </div>
        <div class="col-sm-6">
            <?= $form->field($model, 'payDateCertify')->textInput() ?>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($model, 'payAuthorise')->textInput(['maxlength' => true]) ?>
        </div>
        <div class="col-sm-6">
            <?= $form->field($model, 'payDateAuthorise')->textInput() ?>
        </div>
    </div>
