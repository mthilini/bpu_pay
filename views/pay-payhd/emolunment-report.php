...
<div class="card">
    <div class="card-bofy m-2">
        ...
        <?=
        $this->render('_emolunment-search', [
            'request' => $request,
            'payFields' => $payFields,
        ]);
        ?>
...
<script>
    $(document).ready(function() {
        ...
        var fldName = ($('#fldCode').val() != '0') ? $('#fldCode').find(":selected").text() : 'All';
                        ...
                        },
                        {
                            ...
                            customize: function(win) {
                                $(win.document.body)
                                    ...
                                    .prepend(
                                        'Buddhist and Pali Universitry <br>Emolument List : ' + date
                                    );
