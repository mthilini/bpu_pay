...
<script>
    $(document).ready(function() {
        ...
        var fldName = ($('#a14Code').val() != '') ? $('#a14Code').find(":selected").text() : 'All';
                        ...
                        },
                        {
                            ...
                            customize: function(win) {
                                $(win.document.body)
                                    ...
                                    .prepend(
                                        'Buddhist and Pali Universitry <br>A14 List : ' + date
                                    );
