        ...
        <div class="emp-container">
            ...
            <table class="fl-table" style="margin-top: 25px; width: 100%; border: none;">
                <thead>
                    <tr>
                        <th width="3%"></th>
                        <th colspan="4" class="align-left" style="padding-top: 15px; padding-bottom: 15px; font-size: 13px; font-weight: 500;"><?= 'Department: &nbsp;&nbsp;&nbsp;' . $employees['deptName'] ?></th>
                        <th width="3%"></th>
                    </tr>
                    <tr>
                        <th></th>
                ...
                <tfoot>
                    <tr>
                        <th></th>
                        <th colspan="4" style="border-bottom: 1.5px solid black;"></th>
                        <th></th>
                    </tr>
                    <tr>
                        <td colspan="2"></td>
