        ...
        <div class="emp-container">
            ...
            <table class="fl-table" style="margin-top: 25px; width: 100%; border: none;">
                <thead>
                    <tr>
                        <th width="3%"></th>
                        <th colspan="5" class="align-left" style="padding-top: 15px; padding-bottom: 15px; font-size: 13px; font-weight: 500;"><?= 'Department: &nbsp;&nbsp;&nbsp;' . $employees['deptName'] ?></th>
                        <th width="3%"></th>
                    </tr>
                    <tr>
                        <th></th>
                        ...
                        <th style="font-weight: 500; padding-bottom: 7px; border-bottom: 1.5px solid black; text-align: center; width: 15%;">Gross Pay</th>
                        <th style="font-weight: 500; padding-bottom: 7px; border-bottom: 1.5px solid black; text-align: center; width: 15%;">Signature</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td style="text-align: right; padding-right: 12px;"><?= number_format($employee['iprmGross'], 2, '.', ','); ?></td>
                                <td style="border-bottom: 1.5px dashed black;"></td>
                                <td></td>
                            </tr>
                    <?php
                        }
                ...
                <tfoot>
                    <tr>
                        <th></th>
                        <th colspan="5" style="border-bottom: 1.5px solid black;"></th>
                        <th></th>
                    </tr>
                    <tr>
                        <td colspan="2"></td>
