...
<div class="pay-payhd-search">
    ...
    <?php $form = ActiveForm::begin([
        'action' => ['report'],
        'method' => 'get',
        'action' => ['/pay-payhd/employee-remark-report'],
    ]); ?>
    ...
    <div class="m-2">
        <div class="row">
            ...
            <div class="form-group col-lg-4 col-md-4 col-sm-4">
                ...
                <?= Html::a('Reset', ['/pay-payhd/employee-remark-report'], ['class' => 'btn btn-secondary btn-sm']) ?>
                <?= (isset($request['upfNo']) && !empty($request['upfNo'])) ?
                    '<a type="btn" class="btn btn-warning btn-sm" onclick="return printEmployeeRemarkReport(' . $request['upfNo'] . ');">Print</a>' : '';
                ?>
            </div>
        </div>
    </div>
...
<script>
    function printEmployeeRemarkReport(upfNo) {
