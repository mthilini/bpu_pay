...
<div class="acct-paycash-form">
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <!--cash items-->
            <?= $this->render('cash_items_receipt', [
                'form' => $form,
                'model_cash' => $model_cash,
            ]) ?>

            <!--ledger items-->
            <?= $this->render('ledger_items_rct', [
                'form' => $form,
                'model_ledger' => $model_ledger,
            ]) ?>
        </div>
    ...
    function chcol(value) {
        switch (value) {
            case "cash":
                ...
                document.getElementById("cash_items_receipt").style.display = 'block';
                break;
            case "ledger":
                document.getElementById("cash_items_receipt").style.display = 'none';
