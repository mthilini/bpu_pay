<?php
$this->title = 'University - Journal Final Summary';
...
<div class="card">
    <div class="card-bofy m-2">
        ...
        <?=
        $this->render('_uni-jnlfin-summary-search', [
            'request' => $request,
        ]);
        ?>
        ...
        if (!empty($month) && !empty($year)) { ?>
            ...
            <div id="ifrmDv" style="text-align: center;">
                <iframe id="ifrm" src="uni-jnlfin-summary-report-pdf?month=<?= $month; ?>&year=<?= $year; ?>&option=<?= $option; ?>&empAcademic=<?= $empAcademic; ?>" style="width: 90%; height: 650px;" type="application/pdf"></iframe>
            </div>
        <?php } ?>
    </div>
</div>
