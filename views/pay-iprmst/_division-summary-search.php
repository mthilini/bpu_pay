...
<div class="pay-pay-iprmst-search">
    ...
    <?php $form = ActiveForm::begin([
        'action' => ['report'],
        'method' => 'get',
        'action' => ['/pay-iprmst/division-summary-report'],
    ]); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
                ...
                <select name="deptCode" id="deptCode" class="form-control">
                    ...
                    ?>
                            <option value="<?= $department->deptCode; ?>" <?= (!empty($request['deptCode']) && $request['deptCode'] == $department->deptCode) ? 'selected="selected"' : '' ?>><?= $department->deptName; ?></option>
                    <?php }
                    }
                    ?>
                </select>
            ...
            <div class="form-group col-lg-2 col-md-3 col-sm-3">
                ...
                <?= Html::a('Reset', ['/pay-iprmst/division-summary-report'], ['class' => 'btn btn-secondary btn-sm']) ?>
            </div>
        </div>
    </div>
